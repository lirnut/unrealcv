...
- :doc:`sensor-system` - Sensor system architecture
- :doc:`recording-pipeline` - Recording pipeline
...
**Description:**
RGB rendering of a single actor with transparent background.
The actor is rendered normally, everything else is alpha=0.
...
- :doc:`sensor-system` - Sensor system architecture
- :doc:`../api/sensor-bplib` - SensorBPLib API
